...
import { ArrowUpRightIcon, Download, DownloadIcon, TrashIcon } from "lucide-react"
                ...
                return(
                  <div key={thumb._id} onClick={()=>navigate(`/generate/${thumb._id}`)} className="mb-8 group relative cursor-pointer rounded-2xl bg-white/6 border border-white/10 transition shadow-xl break-inside-avoid">
                   ...
                   <div  className={`relative overflow-hidden rounded-t-2xl $(aspectClass) bg-black`}>
                    ...
                    justify-center text-sm font-medium text-white">Generating...</div>}
                   </div>
                   {/* CONTENT */}
                   <div className="p-4 space-y-2">
                      <h3 className="tetxt-sm font-semibold
                       text-zinc-100 line-clamp-2">{thumb.title}</h3>
                   ...
                   right-2 max-sm:flex sm:hidden group-hover:flex gap-1.5">
                    <TrashIcon 
