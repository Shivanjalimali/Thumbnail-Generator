  ...
  return (
    <>
      ...
      <div className="pt-24 min-h-screen">
        <main className="max-w-6xl mx-auto sm:px-6 lg:px-8 py-8 pb-28 lg:pb-8">
            <div className="grid lg:grid-cols-[400px_1fr] gap-8">
                    ...
                    <div className="p-6 rounded-2xl bg-white/8 border-white/12 shadow-xl space-y-6 ">
                        <div>
                            ...
                            <p className="text-sm text-zin-400">
                                Describe your vision and let A bring it to life
                            </p>
                        </div>
                            ...
                            {/*COLORSCHMESELECTOR   */}
                             ...
                             <div className="space-y-2">
                                <label className="block text-sm font-medium">
                                    Additional Promts <span className="text-zinc-400
                                ...
                                <textarea value={additionalDetails} onChange={(e)=>setAdditionalDetails(e.target.value)} rows={3} placeholder="Add any specific elements,mood,or style preferences..."
                                    ...
                                    placeholder:text-zinc-400 focus:outline-none focus:ring-pink-500 resize-none"/>
                             </div>
                        </div>
                        {/* BUTTON */}
                        {!id&&(
                ...
                <div>
                    <div className="p-6 rounded-lg bg-white/8 border border-white/10 shadow-xl">
